...
updating while acknowledgments are delayed; `records_checkpointed` counts only
backend-confirmed progress. See [metrics and health](metrics.md#health-snapshots).
