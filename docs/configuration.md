...
| `WithInFlightLimits` | `InFlightLimits` | disabled | [Bound admitted records/bytes and fetched/staged pages](in-flight-limits.md); split batches into ordered prefixes. Zero fields select documented defaults. | All fields `>= 0` |
